...
const NavBar = () => {
  ...
  return (
    <div className="w-full p-[10px] flex justify-between items-center">
      ...
      {!toggle?  <svg xmlns="http://www.w3.org/2000/svg" fill="none" onClick={()=>setToggle(!toggle)}
        viewBox="0 h-6 cursor-pointer md:hidden">
  ...
  <path strokeLinecap="rou0 24 24" strokeWidth={1.5} stroke="currentColor"
         className="w-6 nd" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
</svg>
}
