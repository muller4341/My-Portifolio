        ...
        <div className='grid grid-cols-1 md:grid-cols-2 justify-evenly px-10 md:px-44'>
           ...
           <div className='flex flex-col '>
            ...
            <input type="text"  placeholder='yourname@gmail.com'
             className='border-[1.5px] px-2 bg-yellow-400 
              hover:border-yellow-600 rounded-md'  />
            </div>
            <div className='flex flex-col'>
            <label className='text-gray-400 '>Message</label>
            <textarea type="text" rows={7} placeholder='Type your message here'
             className='border-[1.5px] px-2 hover:border-yellow-600 border-yellow-400 rounded-md'  />
           <button className='transition-all ease-in-out hover:scale-110 bg-yellow-600 flex flex-row items-center justify-center text-[14px]  py-1 mt-5 text-white  rounded-md'>
           Submit
